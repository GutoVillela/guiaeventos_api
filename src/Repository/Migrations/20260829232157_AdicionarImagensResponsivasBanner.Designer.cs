...
namespace Repository.Migrations
{
    ...
    [Migration("20260829232157_AdicionarImagensResponsivasBanner")]
    partial class AdicionarImagensResponsivasBanner
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repository.Outbox.OutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Domain.Entities.Banner", b =>
                {
                    ...
                    b.OwnsOne("Domain.ValueObjects.Image", "MobileImage", b1 =>
                        {
                            b1.Property<int>("BannerId")
                                .HasColumnType("int");
                            ...
                            b1.Property<string>("AltText")
                                .HasMaxLength(300)
                                .HasColumnType("varchar(300)")
                                .HasColumnName("MobileImage_AltText");

                            b1.Property<string>("Url")
                                .HasMaxLength(500)
                                .HasColumnType("varchar(500)")
                                .HasColumnName("MobileImage_Url");
                    ...
                    b.OwnsOne("Domain.ValueObjects.Image", "TabletImage", b1 =>
                        {
                            b1.Property<int>("BannerId")
                                .HasColumnType("int");
                            ...
                            b1.Property<string>("AltText")
                                .HasMaxLength(300)
                                .HasColumnType("varchar(300)")
                                .HasColumnName("TabletImage_AltText");

                            b1.Property<string>("Url")
                                .HasMaxLength(500)
                                .HasColumnType("varchar(500)")
                                .HasColumnName("TabletImage_Url");
