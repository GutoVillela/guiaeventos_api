...
internal class CategoryMap : EntityMap<Category>
{
    public override void Configure(EntityTypeBuilder<Category> builder)
    {
        ...
        builder.Property(x => x.HighlightIcon).HasMaxLength(50).IsRequired(false);
        builder.Property(x => x.Type).HasConversion<string>().HasMaxLength(20).IsRequired().HasDefaultValue(CategoryType.Place);
